...
def tail_portfolio_health_history(
    *,
    history_path: str = DEFAULT_PORTFOLIO_HEALTH_HISTORY,
    n: int = 5,
    as_of: str | None = None,
...
def stats_portfolio_health_history(
    *,
    history_path: str = DEFAULT_PORTFOLIO_HEALTH_HISTORY,
    days: int = 7,
    as_of: str | None = None,
    ...
    return {
        "schema_version": PORTFOLIO_HEALTH_REPORT_SCHEMA_VERSION,
        "command": "portfolio_health_stats",
        "task": "health",
        "history": {
            "path": payload["ledger"],
            "as_of": payload["as_of"],
...
def diff_portfolio_health_history(
    *,
    history_path: str = DEFAULT_PORTFOLIO_HEALTH_HISTORY,
    a: str = "prev",
    b: str = "latest",
